...
local function Main_DynamicKillAnnouncer()
	...
	DynamicKillAnnouncerFrame.text:SetJustifyH("CENTER")
	DynamicKillAnnouncerFrame.text:SetJustifyV("CENTER")
	...
	DynamicKillAnnouncerHeader.text:SetJustifyH("CENTER")
	DynamicKillAnnouncerHeader.text:SetJustifyV("CENTER")
